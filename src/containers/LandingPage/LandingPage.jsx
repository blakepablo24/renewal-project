...
export default function LandingPage(props){
    ...
    const changeBackgroundImage = function(){
        if(banner.bannerItem === banners.bannerItems.length - 1){
            setBanner({
                bannerItem: 0
            });
        } else {
            setBanner({
                bannerItem: banner.bannerItem + 1
            })
        }
      }

    const changeToNextImageHandler = function(){
        setBanner({
            bannerItem: banner.bannerItem + 1
        })
    }

    const changeToPreviousImageHandler = function(){
        setBanner({
            bannerItem: banner.bannerItem - 1
        })
    }
    ...
    return(
        <div className={classes.landingPage}>
            <div className={classes.bannerContainer}>
                <GrFormPrevious className={shownPreviousButton} onClick={changeToPreviousImageHandler} />
                <GrFormNext className={shownNextButton} onClick={changeToNextImageHandler} />
                {banners.bannerItems[banner.bannerItem]}
            </div>
            ...
            <div className={classes.pillarsContainer}>
                <div className={classes.pillar}>
                    <h2 className={classes.pillarTitle}>{props.subjects[0]}</h2>
                ...
                <div className={classes.pillar}>
                    <h2 className={classes.pillarTitle}>{props.subjects[1]}</h2>
                ...
                <div className={classes.pillar}>
                    <h2 className={classes.pillarTitle}>{props.subjects[2]}</h2>
                ...
                <div className={classes.pillar}>
                    <h2 className={classes.pillarTitle}>{props.subjects[3]}</h2>
            ...
            <button className='main-button' onClick={props.changeSubjectHandler.bind(this, "")}>
                <h4>Contact Us</h4>
            </button>
            <div className={classes.landingPageFullScreen}>
                <div className='image-and-paragraphs-container'>
