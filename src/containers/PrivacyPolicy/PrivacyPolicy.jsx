...
export default function PrivacyPolicy(){
    ...
    return(
        <div className={classes.PrivacyPolicy}>
            ...
            <p className='policy-paragraph'>Renewal Project Limited (“we”, “us”) is the operator of the website www.vanguardstorage.co.uk. We collect, use and are responsible for certain information about you. When we do so, we are regulated under the General Data Protection Regulation which applies across the European Union (including the United Kingdom) and we are responsible as ‘controller’ of that personal information for the purposes of those laws. The person responsible for how we handle personal information is Jasper Taylor, jasper-taylor@renewal-project.co.uk .</p>
